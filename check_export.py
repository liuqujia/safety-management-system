...
print("=== 查看容器内issues.py的导出部分 ===")
stdin, stdout, stderr = ssh.exec_command('echo Jia501688921 | sudo -S docker exec safety-management-api grep -n "export" /app/app/api/issues.py')
